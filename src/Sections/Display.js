      ...
      >
        <Card
          ...
          style={{
            justifySelf: "center",
            height: "100%",
            backgroundImage: `linear-gradient(to bottom  , rgba(0, 0, 0, 0.6), rgba(255, 0, 0, 0),rgba(0,0,0,0.5)), url(${TEST6})`,
            borderRadius: "0.5em",
          }}
        >
          <motion.div
            whileInView={{ backdropFilter: ["blur(0px)", "blur(7px)"] }}
          ...
          >
            <CardContent style={{ alignItems: "center", padding: "5%" }}>
              <Typography
                ...
                fontWeight={500}
                align="left"
                sx={{ letterSpacing: 5, textTransform: "uppercase" }}
              >
              ...
              <Typography
                ...
                fontWeight={500}
                align="left"
                sx={{ textTransform: "uppercase", letterSpacing: 8 }}
              >
                <span className="yellow" style={{ color: "yellow" }}>
                  Nikon Z5
                </span>
              </Typography>
              <Typography
              ...
              >
                <span className="blue">
                  24 -70 F4S | 50mm F1.8G | 85mm f1.8{" "}
                </span>
              </Typography>
            </CardContent>
          </motion.div>
