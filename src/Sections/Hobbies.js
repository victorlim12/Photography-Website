          ...
          <CardContent margin={"5%"} max={"60vw"}>
            ...
            <Typography variant="h5" fontWeight={300} align="left">
              <span className="blue" style={{ fontWeight: "600" }}>
                pondering upon what's in this life that's worth living for.
              </span>
            </Typography>
          </CardContent>
          <Cards
            ...
            <CardContent>
              <Typography variant="h2" fontWeight={500} align="center">
                <span
                  ...
                  style={{
                    fontWeight: "600",
                    filter: "drop-shadow(4px 3px 3px #333434)",
                  }}
                >
                  {" "}
                  It's just like a Supercut.
                </span>
              </Typography>
              <Typography variant="h5" fontWeight={600} align="center">
                <span className="blue" style={{ fontWeight: "600" }}>
                  Things plays out and end in my head.
                </span>
              </Typography>
            </CardContent>
          </Cards>
          ...
          >
            <CardContent max={"42vw"}>
              <Typography variant="h3" fontWeight={600} align="center">
                <span className="orange"> in my head.</span>
              </Typography>
              <Typography variant="h5" fontWeight={500} align="center">
                <span className="">Drowning in feelings. </span>
              </Typography>
            </CardContent>
          </Cards>
          <Cards
